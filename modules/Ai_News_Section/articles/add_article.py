...
def submit_data():
    ...
    try:
        ...
        df = pd.DataFrame(columns=["Date", "URL", "Title", "Author", "Source"])
    ...
    if title in df['Title'].values:
        ...
        new_data = {'Date': date, 'URL': url, 'Title': title, 'Author': author, 'Source': source}
...
entry_source.grid(row=6, column=1)
